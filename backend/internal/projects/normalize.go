...
// capitalizeFirst делает первую букву заглавной, остальное не трогает,
// но организационно-правовые формы (ООО, АО, ИП…) поднимает целиком
// в любом месте строки: «ооо ромашка» → «ООО Ромашка».
//
// Применяется к названиям (проект, заказчик, город), НЕ к ФИО.
// Пустая строка и строки из одних пробелов возвращаются как есть.
...
// normalizeFullName приводит ФИО к формату «Фамилия И.О.».
//
// Экономисты вводят по-разному: «иванов и.и.», «Иванов и. и.»,
// «иванов иван иванович». Приводим к единому виду, чтобы реестр и
// карточка проекта выглядели одинаково:
//
...
//	«иванов»             → «Иванов»
//
// Если разобрать не удалось, возвращаем исходную строку с заглавной
// первой буквой — молча терять введённое нельзя.
