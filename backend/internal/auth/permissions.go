...
const (
	...
	// RoleNone — учётка создана, роль ещё не назначена. ТЗ: «После
	// создания учётной записи пользователь не имеет доступа к
	// функционалу системы до назначения роли и/или индивидуальных прав».
	// Пустая роль не даёт НИ ОДНОГО базового права, но индивидуальные
	// права сверх роли работают и для неё.
	RoleNone = ""
)
...
// IsGrantable — можно ли выдать право индивидуально сверх роли.
//
// ТЗ: «дополнительные права не могут превышать полномочия главного
// экономиста». У ГЭ есть всё, поэтому формально выдать можно любое
// право. Исключение — управление пользователями: выдав его, ГЭ получил
// бы второго ГЭ, а это уже не «право сверх роли», а смена роли, для
// которой в панели есть отдельное действие.
