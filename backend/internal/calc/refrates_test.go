...
// форму как значение по умолчанию и сохраняются в версии бюджета. Расчёт
// обязан брать их оттуда, а к ставкам эталонной формы возвращаться только
// когда в версии их нет — иначе старые версии пересчитались бы иначе.
