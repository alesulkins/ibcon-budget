...
// Тесты индексации ФОТ. ИСТОЧНИК ОЖИДАЕМЫХ ЗНАЧЕНИЙ: спецификация
// санкционированного отклонения №1 из CLAUDE.md, НЕ Excel.
...
// TestAprilIndexation_InterShiftPayStaysFixed — выплата за межвахтовый отдых
// остаётся 30 000 при любой индексации.
