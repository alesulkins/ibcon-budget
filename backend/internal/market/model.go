...
// Признаки объявления: комнаты, площадь, этаж и признак посуточной площадки.
// Порядок фиксирован — на него опирается и обучение, и прогноз.
const (
	fRooms = iota
	fArea
	fFloor
...
// Сколько порогов перебирать в узле.
