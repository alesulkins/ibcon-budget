...
type Estimate struct {
	...
	// объявление на рынке, закладывать его значит переплатить; среднее по
	// той же выборке без верхних пяти процентов даёт цену, по которой
	// квартиру действительно снимают, и учитывает всю выборку, а не
	// только её середину.
