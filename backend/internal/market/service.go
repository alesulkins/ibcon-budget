...
// Насколько площадь объявления может отличаться от заданной.
...
// meanBelow — среднее значений не выше границы.
...
// trimOutliers убирает объявления с ценой за полтора межквартильных размаха
// от квартилей.
...
// examples — по одному-двум объявлениям с каждой площадки, ближе к середине
// цены: крайние объявления производят ложное впечатление.
