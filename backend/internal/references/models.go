...
type Position struct {
	...
	// IsITR — инженерно-технический работник. По этому признаку в
	// выгрузке бюджета считается сводка по ИТР: сколько инженеров в
	// среднем работало в месяц и во сколько обходится человеко-месяц.
	// Рабочие и администрация в неё не входят.
