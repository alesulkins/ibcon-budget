 ...
 *
 * Заменяет постоянные абзацы-пояснения под блоками. Правило владельца
 * 2026-08-27: в иконку прячется только статический текст. Строки с
 * текущими суммами (живой результат) и подписи под последней таблицей
 * листа остаются на виду.
 */
