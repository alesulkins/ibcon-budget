...
// Экран конкретного проекта или версии бюджета — только с такого экрана есть
// смысл возвращаться.
...
export default function AppLayout() {
  ...
  // Вид экрана. Телефон — уже 768 точек (antd md): на такой ширине сайдбар
  // отнимал бы половину экрана, поэтому там он выезжает поверх страницы.
  ...
  // Содержимое панели одно и то же во всех трёх видах экрана — отличается
  // только способ её показать (см. ниже). narrow — панель свёрнута в иконки.
  ...
  const panelBody = (
    <>
        ...
        <Menu
          ...
          // Прозрачное меню поверх растяжки сайдбара: со своей заливкой оно
          // ложилось ровным прямоугольником и гасило градиент.
          inlineIndent={12}
    ...
    <Layout style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <Layout style={{
        ...
        <Header style={{
          ...
          <Dropdown
            // По нажатию, а не по наведению: на телефоне и планшете
            // наведения нет вовсе — меню в шапке (вход в личный кабинет
            // и выход) там не открывалось.
            trigger={['click']}
            menu={{
              items: [
                {
