...
/**
 * Плашка статуса: приглушённый цвет текста на нём же с прозрачностью
 * 15 %. Одна на все экраны — реестр, карточка проекта, справочники,
 * пользователи, журнал изменений.
 *
 * Своя вместо antd Tag: у Tag заливка либо из его собственной палитры
 * (заметно ярче нашей), либо сплошная с белым текстом, если передать
 * произвольный цвет. Нужного «мягкого» состояния у него нет.
 */
