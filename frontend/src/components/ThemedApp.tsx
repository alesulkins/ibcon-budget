 ...
 *
 * Уведомление красится целиком, а цвет уведомлений выбирает
 * пользователь: на тёмно-синем нужен белый текст, на светло-розовом —
 * тёмный. Порог — по воспринимаемой яркости (та же формула, что у
 * коэффициентов sRGB в рекомендациях по контрасту).
 */
...
export default function ThemedApp() {
  ...
  useEffect(() => {
    ...
    // Прозрачность подобрана так, чтобы сквозь панель читалось, что под
    // ней, но текст на ней оставался разборчивым: плотнее — и стекла не
    // видно, прозрачнее — и подписи начинают спорить с цифрами фона.
