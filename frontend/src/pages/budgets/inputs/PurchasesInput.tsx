 ...
 *
 * Общая для 4.7 (приборы стройконтроля) и 4.12 (корпоративы). В отличие
 * от вагончиков (4.4), доступны все месяцы проекта, включая последние два,
 * поэтому allowedMonths таблице не передаётся.
 */
