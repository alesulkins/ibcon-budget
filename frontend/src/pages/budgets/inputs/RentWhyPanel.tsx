 ...
 *
 * Внутри — методика: как считается цена для бюджета, чем среднее
 * отличается от медианы, что такое перцентиль и какие объявления
 * отбрасываются. Текст приходит с сервера, где живёт и сам расчёт:
 * пояснение должно меняться вместе с ним, а не отдельно.
 */
