...
// сделать с учёткой, в одном месте: ФИО, роль, статус, доступ к проектам,
// пароль.
export default function UserPanel({ user, projects, onClose }: Props) {
  ...
  useEffect(() => {
    ...
    // Значение выпадающего списка берём из индивидуального гранта на этот
    // проект: «Все права» побеждает, если грантов несколько.
