 ...
 *
 * Город выбирается из справочника, а не вводится строкой: свободная
 * строка развела бы «Санкт-Петербург» и «санкт-петербург» на два города
 * с отдельными окладами. Новый город добавляется тут же — уходить в
 * другой раздел ради одной строки незачем.
 */
